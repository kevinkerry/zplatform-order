...
public class PojoTxncodeDef implements java.io.Serializable {
	...
	/** default constructor */
	public PojoTxncodeDef() {
	}

	/** minimal constructor */
	public PojoTxncodeDef(Long txnid) {
		this.txnid = txnid;
	}

	/** full constructor */
	public PojoTxncodeDef(Long txnid, String apptype, String txntype,
