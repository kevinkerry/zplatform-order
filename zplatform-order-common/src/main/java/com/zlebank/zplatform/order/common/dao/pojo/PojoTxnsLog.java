 ...
 * @author guojia
 * @version
 * @date 2016年9月13日 下午5:27:37
 * @since
 */
@Entity
@Table(name = "T_TXNS_LOG")
public class PojoTxnsLog implements Serializable {
	...
	/**
	 * @param acccoopinstino
	 *            the acccoopinstino to set
	 */
