 ...
 * 
 */
package com.zlebank.zplatform.order.common.dao.pojo;
 ...
 * @author guojia
 * @version
 * @date 2016年9月9日 下午4:33:40
 * @since 
 */
@Entity
@Table(name = "T_TXNS_ORDERINFO")
public class PojoTxnsOrderinfo implements Serializable{
	 ...
	 // Fields
	    ...
	    /** default constructor */
	    public PojoTxnsOrderinfo() {
	    }

	    /** minimal constructor */
	    public PojoTxnsOrderinfo(Long id) {
	        this.id = id;
	    }

	    /** full constructor */
	    public PojoTxnsOrderinfo(Long id, String institution, String orderno,
