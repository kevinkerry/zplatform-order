...
public class PojoTxnsWithdraw implements java.io.Serializable {
    ...
    public PojoTxnsWithdraw (){
    }

    
    public PojoTxnsWithdraw(long id, String withdraworderno, String batchno,
    ...
    public PojoTxnsWithdraw(WithdrawBean withdrawBean,WithdrawAccBean withdrawAccBean) {
    ...
    public PojoTxnsWithdraw(WithdrawOrderBean withdrawBean,com.zlebank.zplatform.order.withdraw.bean.WithdrawAccBean withdrawAccBean) {
   ...
   /* public PojoTxnsWithdraw(TradeBean tradeBean) {
        this.id = 1L;
